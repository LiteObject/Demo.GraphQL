...
namespace Demo.Weather.GraphQL.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class WeatherForecastController : ControllerBase
    {
        ...
        public WeatherForecastController(ILogger<WeatherForecastController> logger, IDocumentExecuter documentExecuter, ISchema schema, IOptions<GraphQLSettings> options)
        {
            _logger = logger;
